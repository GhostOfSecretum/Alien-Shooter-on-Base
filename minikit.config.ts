...
export const minikitConfig = {
  // accountAssociation будет добавлен на шаге 5 после верификации
  {
    "accountAssociation": {
      ...
      "signature": "-uCjiYWX-bmGfd8E0TVZNxQ6s1gldq9YMD45valxOFKBwMkVBppE9_"
    },
  miniapp: {
    version: "1",
    name: "Три в ряд", 
